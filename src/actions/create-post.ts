...
export const createPost = async (slug:string,prevState:CreatePostFormState,formData:FormData) : Promise<CreatePostFormState> => {
    ...
    if(!session || !session.user || !session.user.id){
     ...
     //Checking for topic id and its existence
    ...
    //Post creation's logic by meeting all the necessary conditions mentioned in Post schema
